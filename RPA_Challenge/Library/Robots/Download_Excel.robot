    ...
    "parameters": [{
      ...
      "gizmo":{
        ...
        "typ": {
          ...
          "gizmo":{
            "id": { "string": "RPA_Challenge_Settings" }
          }
        },
        "comment": {
          "meta":{
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Click Left - Download_Excel" }
              }
            },
            "comment": {
              "meta":{
                            ...
                            "componentFinder": {
                              ...
                              "gizmo":{
                                ...
                                "componentSelector": {
                                  ...
                                  "gizmo":{
                                    "text": { "string": "A[der_rendered=\"y\"][href*=\".xlsx\"]" },
                                    "comment": {
                                      "meta":{
                                        "className":"Comment",
                                        "version":0
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Input text from Settings.Input_Path" }
              }
            },
            "comment": {
              "meta":{
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                                ...
                                "applicationFinder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "applicationSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "cef[name=\"rpa_Challenge (2)\"]" },
                                        "comment": {
                                          "meta":{
                                            "className":"Comment",
                                            "version":0
                            ...
                            "imageSelector": {
                              ...
                              "gizmo":{
                                "image": { "image": "iVBORw0KGgoAAAANSUhEUgAAAAEAAAACCAYAAACZgbYnAAAAEklEQVR4XmOYMmXKfwZxcfH/ABWyBAAq6+fZAAAAAElFTkSuQmCC" },
                    ...
                    },
                    {
                      ...
                      "gizmo":{
                        ...
                        "text": {
                          ...
                          "gizmo":{
                            "text": { "string": "=Settings.Input_Path+\"rpa_challenge.xlsx\"" },
                            "comment": {
                              "meta":{
                                "className":"Comment",
                                "version":0
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Click Left - Save" }
              }
            },
            "comment": {
              "meta":{
        ...
        },
        {
          ...
          "gizmo":{
            "name": {
              ...
              "gizmo":{
                "customName": { "string": "Click Left - Close" }
              }
            },
            "comment": {
              "meta":{
